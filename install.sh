...
paru -S --noconfirm --needed base-devel qtile python-psutil pywal-git picom dunst zsh starship mpd ncmpcpp playerctl brightnessctl alacritty pfetch htop flameshot thunar roficlip rofi ranger cava neovim vim feh sddm noto-fonts pipewire pipewire-pulse pamixer easyeffects 
...
backup_and_install ".config/gtk-3.0" "./.config/gtk-3.0"
backup_and_install ".config/qt5ct" "./.config/qt6ct"
